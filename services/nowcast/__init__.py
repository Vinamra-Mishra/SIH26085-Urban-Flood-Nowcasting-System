...
NOWCAST_METHOD_ADVECTION = "NOWCAST-ADVECTION-OF-V1"
NOWCAST_METHOD_NEURAL = "NOWCAST-NEURAL-V1"
NOWCAST_METHOD_BLENDING = "NOWCAST-BLENDING-V1"
NOWCAST_METHOD_UNIFIED = "NOWCAST-UNIFIED-V1"
